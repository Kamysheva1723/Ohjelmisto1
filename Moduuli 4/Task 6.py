"""
Toteutetaan algoritmi piin (π) likiarvon laskemiseksi. Oletetaan,
että A on yksikköympyrä eli ympyrä, jonka keskipiste on origossa ja jonka säde on yksi.
...
joka kysyy arvottavien pisteiden määrän käyttäjältä ja toteuttaa piin likiarvon
